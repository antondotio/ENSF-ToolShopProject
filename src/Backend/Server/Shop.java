...
public class Shop implements Runnable {
	 ...
	 * @return string with items name and quantity or a message saying the item wasn't found
	 */
	...
	/**
	 * helper function for the search function to identify if it needs to search by name of id
